...
| **South Korea Power Grid 5-Minute Data** | KPX 전력수요 예측, 발전기 dispatch target, state-estimated output을 5분 단위로 정리 | [repo](https://github.com/TaeyanG4/korea-power-grid) | [dataset](https://www.kaggle.com/datasets/taeyangg4/south-korea-power-grid-5-minute) | 10억+ rows / primary Parquet 약 1.99 GB | 10.0 |
